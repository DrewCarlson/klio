...
fun main() {
    val f: DateTimeFormat<DateTimeComponents> = DateTimeComponents.Format {
    ...
    for (zone in TimeZone.availableZoneIds) {
        if (f.parse("2008-06-03T11:05:30.123456789+01:00[$zone]").timeZoneId != zone) bad++
    }
    println("declared bad=$bad")
}
