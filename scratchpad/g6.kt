...
fun main() {
    ...
    val b = f.parse("2008-06-03T11:05:30.123456789+01:00[America/New_York]")
    println("year=" + b.year + " month=" + b.monthNumber + " hour=" + b.hour + " offHours=" + b.offsetHours + " tz=" + b.timeZoneId)
}
