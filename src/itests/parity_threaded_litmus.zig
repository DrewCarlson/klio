...
const RUNNABLE = [_][]const u8{
    ...
    "tl_dispatched_cancellation_is_not_failure",
    "tl_dispatched_failure_after_resume",
...
test "tl_dispatched_cancellation_is_not_failure" {
    try check("tl_dispatched_cancellation_is_not_failure");
}

test "tl_dispatched_failure_after_resume" {
    try check("tl_dispatched_failure_after_resume");
}
...
test "mm1_no_tearing" {
    try checkConformance("mm1_no_tearing");
}
test "mm2_drf_sc" {
    try checkConformance("mm2_drf_sc");
}
test "mm3_no_oota" {
    try checkConformance("mm3_no_oota");
}
test "mm4_safe_publication" {
    try checkConformance("mm4_safe_publication");
}
test "mm5_volatile" {
    try checkConformance("mm5_volatile");
}
test "mm6_monitor" {
    try checkConformance("mm6_monitor");
}
test "mm7_atomics" {
    try checkConformance("mm7_atomics");
}
test "mm8_thread_join" {
    try checkConformance("mm8_thread_join");
}
test "mm9_coroutine_hb" {
    try checkConformance("mm9_coroutine_hb");
}
test "mm10_channel_flow" {
    try checkConformance("mm10_channel_flow");
}
...
test "conformance_suite_is_complete" {
    ...
    for (RUNNABLE_MM) |s| try classified.append(a, s);
