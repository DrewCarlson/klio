...
pub const toC = value_mod.toC;
pub const fromC = value_mod.fromC;
...
pub const RangeData = value_mod.RangeData;
pub const RangeRef = value_mod.RangeRef;
pub const rangeRefOf = value_mod.rangeRefOf;
pub const BoundMethodData = value_mod.BoundMethodData;
pub const boundMethodRefOf = value_mod.boundMethodRefOf;
pub const MapEntryData = value_mod.MapEntryData;
...
pub const SHAPE_UNSET = class_mod.SHAPE_UNSET;
pub const SHAPE_NONE = class_mod.SHAPE_NONE;
