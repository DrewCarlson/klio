...
fn neg_type_mismatch() {
    assert!(
        type_codes_for("neg_type_mismatch.kt")
            .iter()
            .any(|c| c == "T0001")
    );
}
...
fn neg_null_deref() {
    assert!(
        type_codes_for("neg_null_deref.kt")
            .iter()
            .any(|c| c == "T0003")
    );
}
...
fn neg_val_reassign() {
    assert!(
        type_codes_for("neg_val_reassign.kt")
            .iter()
            .any(|c| c == "T0006")
    );
}
...
fn neg_wrong_arg_type() {
    assert!(
        type_codes_for("neg_wrong_arg_type.kt")
            .iter()
            .any(|c| c == "T0001")
    );
}
...
fn neg_abstract_instantiate() {
    assert!(
        type_codes_for("neg_abstract_instantiate.kt")
            .iter()
            .any(|c| c == "T0007")
    );
}
...
fn neg_override_needed() {
    assert!(
        type_codes_for("neg_override_needed.kt")
            .iter()
            .any(|c| c == "T0009")
    );
}
...
fn neg_override_no_base() {
    assert!(
        type_codes_for("neg_override_no_base.kt")
            .iter()
            .any(|c| c == "T0011")
    );
}
...
fn neg_override_parent_not_open() {
    assert!(
        type_codes_for("neg_override_parent_not_open.kt")
            .iter()
            .any(|c| c == "T0010")
    );
}
...
fn neg_prop_override_needed() {
    assert!(
        type_codes_for("neg_prop_override_needed.kt")
            .iter()
            .any(|c| c == "T0009")
    );
}
...
fn neg_delegate_missing_operator() {
    assert!(
        type_codes_for("neg_delegate_missing_operator.kt")
            .iter()
            .any(|c| c == "T0012")
    );
}
...
fn neg_operator_keyword_missing_plus() {
    assert!(
        type_codes_for("neg_operator_keyword_missing_plus.kt")
            .iter()
            .any(|c| c == "T0087")
    );
}
...
fn neg_operator_keyword_missing_get() {
    assert!(
        type_codes_for("neg_operator_keyword_missing_get.kt")
            .iter()
            .any(|c| c == "T0087")
    );
}
...
fn neg_operator_signature_inc_takes_arg() {
    assert!(
        type_codes_for("neg_operator_signature_inc_takes_arg.kt")
            .iter()
            .any(|c| c == "T0088")
    );
}
...
fn neg_operator_signature_compareto_return() {
    assert!(
        type_codes_for("neg_operator_signature_compareto_return.kt")
            .iter()
            .any(|c| c == "T0088")
    );
}
...
fn neg_diamond_conflict() {
    assert!(
        type_codes_for("neg_diamond_conflict.kt")
            .iter()
            .any(|c| c == "T0013")
    );
}
...
fn neg_lateinit_val() {
    assert!(
        type_codes_for("neg_lateinit_val.kt")
            .iter()
            .any(|c| c == "T0014")
    );
}
...
fn neg_lateinit_primitive() {
    assert!(
        type_codes_for("neg_lateinit_primitive.kt")
            .iter()
            .any(|c| c == "T0015")
    );
}
...
fn neg_lateinit_initializer() {
    assert!(
        type_codes_for("neg_lateinit_initializer.kt")
            .iter()
            .any(|c| c == "T0016")
    );
}
...
fn neg_lateinit_nullable() {
    assert!(
        type_codes_for("neg_lateinit_nullable.kt")
            .iter()
            .any(|c| c == "T0017")
    );
}
...
fn neg_accessor_return_type_mismatch() {
    assert!(
        type_codes_for("neg_accessor_return_type_mismatch.kt")
            .iter()
            .any(|c| c == "T0018")
    );
}
...
fn neg_when_not_exhaustive() {
    assert!(
        type_codes_for("neg_when_not_exhaustive.kt")
            .iter()
            .any(|c| c == "T0019")
    );
}
...
fn neg_var_not_definitely_assigned() {
    assert!(
        type_codes_for("neg_var_not_definitely_assigned.kt")
            .iter()
            .any(|c| c == "T0020")
    );
}
...
fn neg_reified_requires_inline() {
    assert!(
        type_codes_for("neg_reified_requires_inline.kt")
            .iter()
            .any(|c| c == "T0023")
    );
}
...
fn neg_inline_modifier_outside_inline() {
    assert!(
        type_codes_for("neg_inline_modifier_outside_inline.kt")
            .iter()
            .any(|c| c == "T0026")
    );
}
...
fn neg_vararg_misuse() {
    assert!(
        type_codes_for("neg_vararg_misuse.kt")
            .iter()
            .any(|c| c == "T0025")
    );
}
...
fn neg_declaration_variance_violation() {
    assert!(
        type_codes_for("neg_declaration_variance_violation.kt")
            .iter()
            .any(|c| c == "T0024")
    );
}
...
fn neg_definitely_non_null() {
    assert!(
        type_codes_for("neg_definitely_non_null.kt")
            .iter()
            .any(|c| c == "T0027")
    );
}
...
fn neg_unchecked_cast() {
    assert!(
        type_codes_for("neg_unchecked_cast.kt")
            .iter()
            .any(|c| c == "T0028")
    );
}
...
fn neg_infix_modifier_required() {
    assert!(
        type_codes_for("neg_infix_modifier_required.kt")
            .iter()
            .any(|c| c == "T0029")
    );
}
...
fn neg_unresolved_label() {
    assert!(
        type_codes_for("neg_unresolved_label.kt")
            .iter()
            .any(|c| c == "T0030")
    );
}
...
fn neg_private_class_member_from_outside() {
    assert!(
        type_codes_for("neg_private_class_member_from_outside.kt")
            .iter()
            .any(|c| c == "T0031")
    );
}
...
fn neg_protected_member_from_unrelated() {
    assert!(
        type_codes_for("neg_protected_member_from_unrelated.kt")
            .iter()
            .any(|c| c == "T0031")
    );
}
...
fn pos_internal_treated_as_public() {
    ...
    let codes: Vec<_> = tc
        ...
        .collect();
    assert!(
        !codes.iter().any(|c| c == "T0031" || c == "T0032"),
...
fn neg_private_top_level_cross_file() {
    ...
    let first_source = map.get(id_a).source.clone();
    let second_source = map.get(id_b).source.clone();
    let toks_a = Lexer::new(id_a, &first_source).tokenize();
    let toks_b = Lexer::new(id_b, &second_source).tokenize();
    let (ast_a, _) = Parser::new(id_a, &first_source, &toks_a.tokens).parse_file();
    let (ast_b, _) = Parser::new(id_b, &second_source, &toks_b.tokens).parse_file();
...
fn neg_const_val_not_toplevel() {
    assert!(
        type_codes_for("neg_const_val_not_toplevel.kt")
            .iter()
            .any(|c| c == "T0033")
    );
}
...
fn neg_const_val_non_const_init() {
    assert!(
        type_codes_for("neg_const_val_non_const_init.kt")
            .iter()
            .any(|c| c == "T0034")
    );
}
...
fn neg_const_val_bad_type() {
    assert!(
        type_codes_for("neg_const_val_bad_type.kt")
            .iter()
            .any(|c| c == "T0034")
    );
}
...
fn neg_value_class_open() {
    assert!(
        type_codes_for("neg_value_class_open.kt")
            .iter()
            .any(|c| c == "T0035")
    );
}
...
fn neg_value_class_data() {
    assert!(
        type_codes_for("neg_value_class_data.kt")
            .iter()
            .any(|c| c == "T0035")
    );
}
...
fn neg_value_class_two_vals() {
    assert!(
        type_codes_for("neg_value_class_two_vals.kt")
            .iter()
            .any(|c| c == "T0035")
    );
}
...
fn neg_value_class_var() {
    assert!(
        type_codes_for("neg_value_class_var.kt")
            .iter()
            .any(|c| c == "T0035")
    );
}
...
fn neg_value_class_init_block() {
    assert!(
        type_codes_for("neg_value_class_init_block.kt")
            .iter()
            .any(|c| c == "T0035")
    );
}
...
fn neg_annotation_class_body() {
    assert!(
        type_codes_for("neg_annotation_class_body.kt")
            .iter()
            .any(|c| c == "T0036")
    );
}
...
fn neg_annotation_class_open() {
    assert!(
        type_codes_for("neg_annotation_class_open.kt")
            .iter()
            .any(|c| c == "T0036")
    );
}
...
fn neg_annotation_class_param_type() {
    assert!(
        type_codes_for("neg_annotation_class_param_type.kt")
            .iter()
            .any(|c| c == "T0037")
    );
}
...
fn neg_annotation_class_cycle_direct() {
    assert!(
        type_codes_for("neg_annotation_class_cycle_direct.kt")
            .iter()
            .any(|c| c == "T0107")
    );
}
...
fn neg_annotation_class_cycle_array() {
    assert!(
        type_codes_for("neg_annotation_class_cycle_array.kt")
            .iter()
            .any(|c| c == "T0107")
    );
}
...
fn neg_opt_in_missing() {
    assert!(
        type_codes_for("neg_opt_in_missing.kt")
            .iter()
            .any(|c| c == "T0112")
    );
}
...
fn neg_deprecated_error_used() {
    assert!(
        type_codes_for("neg_deprecated_error_used.kt")
            .iter()
            .any(|c| c == "T0111")
    );
}
...
fn neg_annotation_duplicate_non_repeatable() {
    assert!(
        type_codes_for("neg_annotation_duplicate_non_repeatable.kt")
            .iter()
            .any(|c| c == "T0109")
    );
}
...
fn neg_annotation_target_class_only_on_function() {
    assert!(
        type_codes_for("neg_annotation_target_class_only_on_function.kt")
            .iter()
            .any(|c| c == "T0110")
    );
}
...
fn neg_annotation_class_param_default_non_const() {
    assert!(
        type_codes_for("neg_annotation_class_param_default_non_const.kt")
            .iter()
            .any(|c| c == "T0108")
    );
}
...
fn neg_annotation_class_unsupported_user_param() {
    assert!(
        type_codes_for("neg_annotation_class_unsupported_user_param.kt")
            .iter()
            .any(|c| c == "T0037")
    );
}
...
fn neg_recursive_typealias() {
    assert!(
        type_codes_for("neg_recursive_typealias.kt")
            .iter()
            .any(|c| c == "T0038")
    );
}
...
fn neg_typealias_nested_in_class() {
    assert!(
        type_codes_for("neg_typealias_nested_in_class.kt")
            .iter()
            .any(|c| c == "T0039")
    );
}
...
fn neg_extension_property_initializer() {
    assert!(
        type_codes_for("neg_extension_property_initializer.kt")
            .iter()
            .any(|c| c == "T0040")
    );
}
...
fn neg_extension_property_delegate() {
    assert!(
        type_codes_for("neg_extension_property_delegate.kt")
            .iter()
            .any(|c| c == "T0041")
    );
}
...
fn neg_extension_property_needs_accessor() {
    assert!(
        type_codes_for("neg_extension_property_needs_accessor.kt")
            .iter()
            .any(|c| c == "T0042")
    );
}
...
fn neg_delegation_to_class() {
    assert!(
        type_codes_for("neg_delegation_to_class.kt")
            .iter()
            .any(|c| c == "T0043")
    );
}
...
fn neg_delegation_type_mismatch() {
    assert!(
        type_codes_for("neg_delegation_type_mismatch.kt")
            .iter()
            .any(|c| c == "T0044")
    );
}
...
fn neg_data_object_equals() {
    assert!(
        type_codes_for("neg_data_object_equals.kt")
            .iter()
            .any(|c| c == "T0045")
    );
}
...
fn neg_field_outside_accessor() {
    assert!(
        type_codes_for("neg_field_outside_accessor.kt")
            .iter()
            .any(|c| c == "T0046")
    );
}
...
fn neg_field_in_extension_property() {
    assert!(
        type_codes_for("neg_field_in_extension_property.kt")
            .iter()
            .any(|c| c == "T0046")
    );
}
...
fn neg_spread_requires_vararg() {
    assert!(
        type_codes_for("neg_spread_requires_vararg.kt")
            .iter()
            .any(|c| c == "T0047")
    );
}
...
fn neg_tailrec_non_tail() {
    assert!(
        type_codes_for("neg_tailrec_non_tail.kt")
            .iter()
            .any(|c| c == "T0048")
    );
}
...
fn neg_tailrec_no_calls() {
    assert!(
        type_codes_for("neg_tailrec_no_calls.kt")
            .iter()
            .any(|c| c == "T0049")
    );
}
...
fn neg_enum_final_override() {
    assert!(
        type_codes_for("neg_enum_final_override.kt")
            .iter()
            .any(|c| c == "T0050")
    );
}
...
fn neg_throwable_type_params() {
    assert!(
        type_codes_for("neg_throwable_type_params.kt")
            .iter()
            .any(|c| c == "T0051")
    );
}
...
fn neg_throw_non_throwable() {
    assert!(
        type_codes_for("neg_throw_non_throwable.kt")
            .iter()
            .any(|c| c == "T0106")
    );
}
...
fn neg_tailrec_on_open() {
    assert!(
        type_codes_for("neg_tailrec_on_open.kt")
            .iter()
            .any(|c| c == "T0057")
    );
}
...
fn neg_data_class_copy_override() {
    assert!(
        type_codes_for("neg_data_class_copy_override.kt")
            .iter()
            .any(|c| c == "T0059")
    );
}
...
fn neg_data_class_component_override() {
    assert!(
        type_codes_for("neg_data_class_component_override.kt")
            .iter()
            .any(|c| c == "T0058")
    );
}
...
fn neg_secondary_ctor_cycle() {
    assert!(
        type_codes_for("neg_secondary_ctor_cycle.kt")
            .iter()
            .any(|c| c == "T0060")
    );
}
...
fn neg_data_class_no_property() {
    assert!(
        type_codes_for("neg_data_class_no_property.kt")
            .iter()
            .any(|c| c == "T0061")
    );
}
...
fn neg_data_class_vararg_property() {
    assert!(
        type_codes_for("neg_data_class_vararg_property.kt")
            .iter()
            .any(|c| c == "T0062")
    );
}
...
fn neg_annotation_array_bad_element() {
    assert!(
        type_codes_for("neg_annotation_array_bad_element.kt")
            .iter()
            .any(|c| c == "T0037")
    );
}
...
fn neg_inline_property_initializer() {
    assert!(
        type_codes_for("neg_inline_property_initializer.kt")
            .iter()
            .any(|c| c == "T0053")
    );
}
...
fn neg_no_backing_field_initializer() {
    assert!(
        type_codes_for("neg_no_backing_field_initializer.kt")
            .iter()
            .any(|c| c == "T0054")
    );
}
...
fn neg_inline_param_leak() {
    assert!(
        type_codes_for("neg_inline_param_leak.kt")
            .iter()
            .any(|c| c == "T0055")
    );
}
...
fn neg_crossinline_param_leak() {
    assert!(
        type_codes_for("neg_crossinline_param_leak.kt")
            .iter()
            .any(|c| c == "T0056")
    );
}
...
fn neg_published_api_missing() {
    assert!(
        type_codes_for("neg_published_api_missing.kt")
            .iter()
            .any(|c| c == "T0031")
    );
}
...
fn neg_diamond_class_interface() {
    assert!(
        type_codes_for("neg_diamond_class_interface.kt")
            .iter()
            .any(|c| c == "T0013")
    );
}
...
fn neg_diamond_abstract_concrete() {
    assert!(
        type_codes_for("neg_diamond_abstract_concrete.kt")
            .iter()
            .any(|c| c == "T0013")
    );
}
...
fn neg_override_return_type() {
    assert!(
        type_codes_for("neg_override_return_type.kt")
            .iter()
            .any(|c| c == "T0065")
    );
}
...
fn neg_override_property_mutability() {
    assert!(
        type_codes_for("neg_override_property_mutability.kt")
            .iter()
            .any(|c| c == "T0066")
    );
}
...
fn neg_override_property_type() {
    assert!(
        type_codes_for("neg_override_property_type.kt")
            .iter()
            .any(|c| c == "T0067")
    );
}
...
fn neg_suspend_call_from_non_suspend() {
    assert!(
        type_codes_for("neg_suspend_call_from_non_suspend.kt")
            .iter()
            .any(|c| c == "T0115")
    );
}
...
fn neg_override_suspend_added() {
    assert!(
        type_codes_for("neg_override_suspend_added.kt")
            .iter()
            .any(|c| c == "T0069")
    );
}
...
fn neg_override_suspend_dropped() {
    assert!(
        type_codes_for("neg_override_suspend_dropped.kt")
            .iter()
            .any(|c| c == "T0069")
    );
}
...
fn neg_override_visibility_stronger() {
    assert!(
        type_codes_for("neg_override_visibility_stronger.kt")
            .iter()
            .any(|c| c == "T0068")
    );
}
...
fn neg_sealed_local_inheritor() {
    assert!(
        type_codes_for("neg_sealed_local_inheritor.kt")
            .iter()
            .any(|c| c == "T0071")
    );
}
...
fn neg_sealed_anonymous_inheritor() {
    assert!(
        type_codes_for("neg_sealed_anonymous_inheritor.kt")
            .iter()
            .any(|c| c == "T0071")
    );
}
...
fn neg_private_open() {
    assert!(
        type_codes_for("neg_private_open.kt")
            .iter()
            .any(|c| c == "T0070")
    );
}
...
fn neg_private_override() {
    assert!(
        type_codes_for("neg_private_override.kt")
            .iter()
            .any(|c| c == "T0070")
    );
}
...
fn neg_inherit_from_final() {
    assert!(
        type_codes_for("neg_inherit_from_final.kt")
            .iter()
            .any(|c| c == "T0063")
    );
}
...
fn neg_inherit_from_object() {
    assert!(
        type_codes_for("neg_inherit_from_object.kt")
            .iter()
            .any(|c| c == "T0064")
    );
}
...
fn neg_data_class_open() {
    assert!(
        type_codes_for("neg_data_class_open.kt")
            .iter()
            .any(|c| c == "T0072")
    );
}
...
fn neg_enum_class_abstract() {
    assert!(
        type_codes_for("neg_enum_class_abstract.kt")
            .iter()
            .any(|c| c == "T0072")
    );
}
...
fn pos_definitely_non_null_on_type_param() {
    ...
    let codes: Vec<_> = tc
        ...
        .collect();
    assert!(
        !codes.iter().any(|c| c == "T0027"),
        "unexpected T0027 on type parameter use: {codes:?}"
    );
}
...
#[test]
fn neg_catch_type_param() {
    assert!(
        type_codes_for("neg_catch_type_param.kt")
            .iter()
            .any(|c| c == "T0105")
    );
}
...
#[test]
fn neg_catch_type_args() {
    assert!(
        type_codes_for("neg_catch_type_args.kt")
            .iter()
            .any(|c| c == "T0105")
    );
}
