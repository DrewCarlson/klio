...
// natively to the same monitor table in klio-kotlinx-coroutines's
// `src/lib.rs`, so even an explicit fully-qualified call observes
// real exclusion. The Kotlin body below stays as a defensive
