...
impl From<ktc_ast::Variance> for Variance {
    fn from(v: ktc_ast::Variance) -> Self {
        match v {
            ktc_ast::Variance::Invariant => Self::Invariant,
            ktc_ast::Variance::Out => Self::Out,
            ktc_ast::Variance::In => Self::In,
        }
    }
}
