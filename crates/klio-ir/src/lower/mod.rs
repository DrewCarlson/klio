...
use inline_state::{inline_fn_ast, inline_fn_ast_for, is_top_level_prop};
pub use inline_state::{set_inline_fn_asts, set_shadowed_inline_names, set_top_level_prop_names};
use lambda_body::{
