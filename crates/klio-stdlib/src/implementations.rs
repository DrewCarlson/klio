...
const TABLE: &[(&str, StdlibFn)] = &[
    ...
    ("kotlin.math.sinh", math_sinh),
    ("kotlin.math.cosh", math_cosh),
    ("kotlin.math.tanh", math_tanh),
    ("kotlin.math.asinh", math_asinh),
    ("kotlin.math.acosh", math_acosh),
    ("kotlin.math.atanh", math_atanh),
    ("kotlin.math.expm1", math_expm1),
    ("kotlin.math.ln1p", math_ln1p),
    ("kotlin.Float.pow", float_pow),
    ...
    ("kotlin.String.elementAt", char_sequence_element_at),
    ("kotlin.CharSequence.elementAt", char_sequence_element_at),
    ("kotlin.text.StringBuilder.elementAt", char_sequence_element_at),
    ...
    ("kotlin.Double.nextUp", double_next_up),
    ("kotlin.Double.nextDown", double_next_down),
    ("kotlin.Double.nextTowards", double_next_towards),
    ("kotlin.Double.ulp", double_ulp),
    ("kotlin.Double.withSign", double_with_sign),
    ("kotlin.Float.withSign", float_with_sign),
    ...
    ("kotlin.Array.orEmpty", array_or_empty),
    ("kotlin.collections.Array.orEmpty", array_or_empty),
    ("kotlin.Array.contentDeepToString", array_content_deep_to_string),
    ("kotlin.Array.contentDeepEquals", array_content_deep_equals),
    ("kotlin.Array.contentDeepHashCode", array_content_deep_hash_code),
    ("kotlin.Array.contentHashCode", array_content_hash_code),
    ("kotlin.IntArray.contentHashCode", array_content_hash_code),
    ("kotlin.LongArray.contentHashCode", array_content_hash_code),
    ("kotlin.DoubleArray.contentHashCode", array_content_hash_code),
    ("kotlin.FloatArray.contentHashCode", array_content_hash_code),
    ("kotlin.ShortArray.contentHashCode", array_content_hash_code),
    ("kotlin.ByteArray.contentHashCode", array_content_hash_code),
    ("kotlin.CharArray.contentHashCode", array_content_hash_code),
    ("kotlin.BooleanArray.contentHashCode", array_content_hash_code),
    ("kotlin.UIntArray.contentHashCode", array_content_hash_code),
    ("kotlin.ULongArray.contentHashCode", array_content_hash_code),
    ("kotlin.UShortArray.contentHashCode", array_content_hash_code),
    ("kotlin.UByteArray.contentHashCode", array_content_hash_code),
    ...
    ("kotlin.text.StringBuilder.setRange", string_builder_set_range),
    ("kotlin.text.StringBuilder.appendRange", string_builder_append_range),
    ("kotlin.text.StringBuilder.insertRange", string_builder_insert_range),
