...
//! `ktc-stdlib` can express Rust-native intrinsics in terms of the same
//! types `ktc-interp` evaluates against, without either crate depending on
//! the other.
...
pub enum Value {
    ...
    Function { decl: Rc<ktc_ast::Function>, env: Rc<RefCell<Env>> },
    Lambda { params: Rc<Vec<String>>, body: Rc<ktc_ast::Block>, env: Rc<RefCell<Env>> },
...
pub struct ClassDef {
    ...
    pub init_blocks: Vec<Rc<ktc_ast::Block>>,
    pub is_data: bool,
    pub is_object: bool,
    ...
    pub parent_ctor_args: Vec<Rc<ktc_ast::Expr>>,
    ...
    pub secondary_ctors: Vec<Rc<ktc_ast::SecondaryCtor>>,
...
pub struct ClassParamDef {
    ...
    pub name: String,
    pub default: Option<Rc<ktc_ast::Expr>>,
}

#[derive(Debug, Clone)]
pub struct MethodDef {
    pub name: String,
    pub decl: Rc<ktc_ast::Function>,
...
pub struct PropertyDef {
    pub name: String,
    pub mutable: bool,
    pub init: Option<Rc<ktc_ast::Expr>>,
    /// Custom getter body, if the source declared `get() = …` / `get() { … }`.
    pub getter: Option<Rc<ktc_ast::Accessor>>,
    /// Custom setter body, if the source declared `set(value) { … }`.
    pub setter: Option<Rc<ktc_ast::Accessor>>,
    ...
    pub delegate: Option<Rc<ktc_ast::Expr>>,
